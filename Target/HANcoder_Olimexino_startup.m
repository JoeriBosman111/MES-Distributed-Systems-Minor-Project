...
actioni = Simulink.Parameter; % Define as parameter
actioni.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
actioni.Value = 0; % Initial value is set to zero, no override

actionp = Simulink.Parameter; % Define as parameter
actionp.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
actionp.Value = 0; % Initial value is set to zero, no override

Direction = Simulink.Parameter; % Define as parameter
Direction.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
Direction.Value = 0; % Initial value is set to zero, no override
