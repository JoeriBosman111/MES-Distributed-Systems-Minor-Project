...
extern void CheckmsgtransmissionCAN1(boolean_T rtu_Enable, uint16_T
  ...
  const real_T *rtd_Board_ID, msg_buffer_type *rtd_Msg_Tx_CAN1, uint32_T
  *rtd_TxID_CAN1, const real_T *rtd_Tx_msg_count_CAN1, const uint8_T
  *rtd_basic_cycle_count, rtB_CheckmsgtransmissionCAN1 *localB,
  rtDW_CheckmsgtransmissionCAN1 *localDW);
extern void CheckmsgtransmissionC_i_Disable(rtB_CheckmsgtransmissionCAN2 *localB,
...
extern void CheckmsgtransmissionCAN2(boolean_T rtu_Enable, uint16_T
  ...
  const real_T *rtd_Board_ID, msg_buffer_type *rtd_Msg_Tx_CAN2, uint32_T
  *rtd_TxID_CAN2, const real_T *rtd_Tx_msg_count_CAN2, const uint8_T
  *rtd_basic_cycle_count, rtB_CheckmsgtransmissionCAN2 *localB,
  rtDW_CheckmsgtransmissionCAN2 *localDW);
...
extern void COMMTaskSyncbc1(boolean_T rtu_Enable, real_T rtu_TimeMark, const
  ...
  *rtd_Rx_State_CAN2, uint32_T *rtd_TxID_CAN1, uint32_T *rtd_TxID_CAN2, const
  ...
  rtDW_COMMTaskSyncbc1 *localDW);
extern void COMPTaskResetVariablesBC1(boolean_T rtu_Enable, real_T rtu_Time_Mark,
...
extern void COMPTaskUpdateLT1(boolean_T rtu_Enable, real_T rtu_Time_Mark, real_T
...
extern void CheckmsgtransmissionC_m_Disable(rtB_CheckmsgtransmissionCAN1_n
  *localB, rtDW_CheckmsgtransmissionCAN1_n *localDW);
extern void CheckmsgtransmissionCAN1_g(boolean_T rtu_Enable, uint16_T
  rtu_LocalTime, real_T rtu_TimeMark, uint8_T rtu_ValueDomainMsg, uint8_T
  rtu_ValueDomainMsg_h, uint8_T rtu_ValueDomainMsg_f, const real_T *rtd_Board_ID,
  ...
  *rtd_Tx_msg_count_CAN1, const uint8_T *rtd_basic_cycle_count,
  rtB_CheckmsgtransmissionCAN1_n *localB, const rtC_CheckmsgtransmissionCAN1_e
  *localC, rtDW_CheckmsgtransmissionCAN1_n *localDW);
extern void CheckmsgtransmissionC_n_Disable(rtB_CheckmsgtransmissionCAN2_o
  *localB, rtDW_CheckmsgtransmissionCAN2_l *localDW);
extern void CheckmsgtransmissionCAN2_i(boolean_T rtu_Enable, uint16_T
  rtu_LocalTime, real_T rtu_TimeMark, uint8_T rtu_ValueDomainMsg, uint8_T
  rtu_ValueDomainMsg_h, uint8_T rtu_ValueDomainMsg_k, const real_T *rtd_Board_ID,
  msg_buffer_type *rtd_Msg_Tx_CAN2, uint32_T *rtd_TxID_CAN2, const real_T
  *rtd_Tx_msg_count_CAN2, const uint8_T *rtd_basic_cycle_count,
  rtB_CheckmsgtransmissionCAN2_o *localB, const rtC_CheckmsgtransmissionCAN2_h
  *localC, rtDW_CheckmsgtransmissionCAN2_l *localDW);
